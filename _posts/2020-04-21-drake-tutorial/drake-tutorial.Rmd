...
![Perks of using `drake`.](images/drake_points.png){width=80%}
...
tibble::tibble(
  ...
  description = c("Build your project.", "Force targets to be out of date and remove target names from the data in the cache.", "Show an interactive visual network representation of your workflow.", "Create drake_plan()-ready functions from scripts.", "Loads built target(s) into your R session.", "Read and return a built target.")
  ) %>% 
knitr::kable()
```
